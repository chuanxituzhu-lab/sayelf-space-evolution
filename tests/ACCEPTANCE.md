...
11. Six independent prompts are generated locally: line, linework, sketch, wall, space generation and film.
12. Each independent prompt has its own copy action, including the film prompt.
13. Five continuity locks are enabled by default.
14. Project JSON can be exported.
15. Workflow Markdown can be exported.
16. No external API is called during local prompt generation or copying.
17. README clearly states the boundary between the local workflow and third-party media generation.
18. README includes the five public workflow demonstration images.
